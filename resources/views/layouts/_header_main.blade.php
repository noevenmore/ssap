<header class="header">
        ...
        <nav class="header_nav nav">
            <ul class="header_menu">
                <li class="header_menu-item">
                    <a href="#" class="header_menu-link">Досліджуй</a>
                </li>
                <li class="header_menu-item">
    ...
    <input class="search_site" type="text" placeholder="Поск на сайте" style="display: none;">
    </form>
    ...
    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1440px, 0px, 0px); transition: all 0s ease 0s; width: 5040px;"><div class="owl-item cloned" style="width: 720px;"><div class="item">
        ...
        </div></div></div></div><div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><img src="img/arowD.svg" alt=""></button><button type="button" role="presentation" class="owl-next"><img src="img/arowD.svg" alt=""></button></div><div class="owl-dots"><button role="button" class="owl-dot active"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button></div></div>

    <div class="header_counter">
        <div id="counter" class="counter">3 / 3</div>
        <div class="line"></div>
    </div>		
</header>