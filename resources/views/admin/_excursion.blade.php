<form action="{{$link}}" method="POST">
    ...
    <div class="form-group">
        ...
        <div id="imageloader" data-list="{{isset($images_list)?$images_list:""}}" data-type="excursion"></div>
    </div>
    ...
    <label><strong>Показывать на главной странице:</strong></label>
    ...
    <label><strong>Индивидуальная или групповая:</strong></label>
    
    <div class="form-check mb-2">
        <input class="form-check-input" type="checkbox" value="1" name="is_individual" {{isset($is_individual)&&$is_individual?'checked':''}}>
        <label class="form-check-label">Является индивидуальным</label>
    </div>

    <div class="form-group">
        <label><strong>Популярность:</strong> (при фильтрации по популярности больше значение - первее)</label>
        <input type="number" name="popularity" class="form-control" placeholder="Введите значение..." value="{{isset($popularity)?$popularity:'0'}}">
    </div>
